...
namespace FruitCommerce.Data.Configuration.EntityConfig
{
   public class CustomerConfig : IEntityTypeConfiguration<FruitCommerce.Domain.Core.Models.Customer>
    {
        public void Configure(EntityTypeBuilder<FruitCommerce.Domain.Core.Models.Customer> builder)
        {
